...
module.exports.getTargetShippingInfo = async (body) => {
  
  try {
    const tcin = extractTcinFromUrl(body.productUrl);

    const url = `https://redsky.target.com/redsky_aggregations/v1/web/gift_card_redeem?key=eb2551e4aa4cdb0a501a9f3b7b6f90a3&tcin=${tcin}`;
